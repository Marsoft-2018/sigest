    function agregarLogro(){
        ...
        $.ajax({
            type: "POST",
            url: "Controladores/ctrlLogros.php",
            data: {
                accion: accion, 
                indicador:indicador, 
                codCriterio:criterio,
                area:area,
                periodo:periodo,
                curso:curso,
                anho:anho
            ...
            error: function(err){
                alertify.error("Error: al agregar el indicador: "+err);
            }
        });
    }
    ...
    function cargarEdicionLogro(id){
        ...
        $.ajax({
            type:"POST",
            url: "Controladores/ctrlLogros.php",
            data: {accion: accion, id:id,idArea:idArea,curso:curso,anho:anho},
            datatype: "json",
    ...
    function guardarCambios(id){
        ...
        $.ajax({
            ...
            data: {
                ...
                codCriterio:criterio, 
                id:id,
                idArea:idArea,curso:curso,anho:anho
            },
            success: function(data){
                cargarListadoLogros();
                $('#logroInfinitivo').val("");
    ...
    function cambiarEstadoLogro(id,estado){        
        ...
        $.ajax({
            type: "POST",
            url: "Controladores/ctrlLogros.php",
            data:{accion:accion, id:id, estado:estado, idArea:idArea,curso:curso,anho:anho},
            success:function(data){
                cargarListadoLogros();
            },
            error:function(){
