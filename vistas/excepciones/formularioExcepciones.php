  ...
  <div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      <div class="x_title seccion-cabecera">
          <h3>MODULO PARA REGISTRO DE EXCEPCIONES EN EL PERIODO <?php echo $periodo ?></h3>
          <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <div class="row">          
          <form method="post" action="" onsubmit="return listarExcepciones()">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                  <button type='submit' class='btn btn-success' id='ConsultarCurso' value='Mostrar' style="margin:0 auto;margin-top:25px;width: 100%;"><i class='fa fa-list'></i> Ver profesores</button>
            </div>                    
          </form>
        </div>  
