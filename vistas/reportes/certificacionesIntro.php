                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6" title='Ayuda sobre las Sedes'>
                              <ul>
                                  ...
                                  <li>Por último presione el botón consultar</li>
                              </ul>
                          </div>
                      </div>
                      <p  style='text-align:left; font-size: 1em;margin-bottom: 20px;'>En caso de necesitar consultar uno o varios estudiantes en particular presionar el botón ver listado y seleccionar el o los estudiantes y presionar el botón consultar</p> 
                    </div>
                  </div>
                </div>
              </div> 
