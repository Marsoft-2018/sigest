 ...
 <?php 
	...
	<table class="table table-striped">
		<thead>
			...
			<tr>
				<th colspan="13">
					<h3 style="padding: 0px; margin: 2px;">PLANILLA DE CALIFICACIONES 123</h3>
				</th>
			</tr>
			<tr>
			...
			<tr>
				...
				<th colspan="9">CALIFICACIONES</th>
			</tr>
			<tr>
				<th>No.</th>
		...
		foreach ($objEstudiantes->Listar() as $value) { ?>
			<tr>
    		    ...
    		    <!---  CODIGO DE LA PLANILLA DE CRITERIOS -->
                    ...
                    ?>
                    <td style=" text-align: center; padding: 0px;"><?php echo round($ochentaProciento,1) ?></td>
                    <td style=" text-align: center; padding: 0px;"><?php echo round($notaPeriodo,1) ?></td>
