                    ...
                    <div class="x_content box-profile">
                      <div class="row">                            
                        ...
                        <div class="col-lg-2 col-md-2">
                            ...
                            <?php                            
                                ...
                                echo "<select class='form-control' id='anho' name='anho' onchange=' limpiarAreaDeTrabajo(); '>";
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-sm-6">
                              <button type='button' class='btn btn-success' id='btnPlanilla' title='Ver Planilla de calificaciones' style="padding: 10px; margin-top:20px; width: 100%" onclick="cargarListaNivelacion()">
                                    <i class="fa fa-list-alt"> Ver Estudiantes</i>
                                </button>
                        </div>
                        <div class="col-lg-6 col-sm-6">
