    ...
    <tr>
        <td width='6%' rowspan="7" valign=top style="width:6.52%;border:solid windowtext 1.5pt;border-left:solid windowtext 1.5pt; border-right:none;padding:3px">
            <p class = "MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height: normal;padding:2px;">
                <img src="<?php echo $escudo ?>" alt="Logo" style="position:relative;  width:90%; height:50px">
            </p>
        </td>
...
<table class="table table-striped" style="margin-top: -18px; margin-bottom: -1px; border: 1.5pt solid black; ">
    <tr>
        ...
        <td width=569 colspan='<?php echo $periodoBol+5 ?>' style='width:426.55pt;border-top:solid black 1.5pt;border-left:none;border-bottom:solid windowtext 1.5pt;border-right:solid windowtext 1.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
    ...
    <tr>
        <td colspan='<?php echo $periodoBol+2 ?>' style='width:118.7pt;border-top:none;border-left:none;border-bottom:solid black 1.0pt;border-right:solid windowtext 1.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
            <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;text-align:center;line-height:normal'>
                <span lang=ES-AR style='font-size:12.0pt'>
                    CALIFICACIONES
                </span>
